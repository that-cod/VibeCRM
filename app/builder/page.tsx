...
export default function BuilderPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      // Call the existing generate API
      const response = await fetch("/api/v1/generate", {
        ...
        body: JSON.stringify({
          prompt: prompt.trim(),
          project_id: "preview-project", // Temporary for preview
        }),
      });
      ...
      <div className="w-1/2 border-r bg-white flex flex-col">
        ...
        <div className="border-b px-6 py-4 bg-gradient-to-r from-blue-600 to-indigo-600">
          ...
          <p className="text-blue-100 text-sm mt-1">
            Describe your CRM and watch it build in real-time
          </p>
        </div>
            ...
            <div className="border-b p-4 bg-blue-50">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex gap-2">
                  <DeployDialog
                    schema={schema}
                    projectName={prompt.slice(0, 30).toLowerCase().replace(/[^a-z0-9]/g, '-') || "my-crm"}
                    trigger={
                  ...
                  />
                  <Button onClick={handleProvision} size="sm" variant="outline">
